...
subtitle: 한 프로젝트안에 여러 프로젝트를 넣을 수 있다구요?ㄴ
date: 2024-03-26
category: posts
tags:
  - 프론트엔드
...
![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/49ba5954-2cfc-48fc-8ccc-1702dd703bf5/ec5f01f5-a26a-45aa-8206-a3e34c00d6e3/Untitled.png)
...
- 제품 전략면에서 독립된 제품들이 기술적으로도 독립
- 내부 알고리즘을 통해 소스 코드가 바뀐 패키지만 빌드하고 나머지는 기존 빌드 결과물을 재사용 함으로써 빌드시간 평균20분 → 3분으로 단축
